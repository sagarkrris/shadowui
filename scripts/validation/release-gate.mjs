...
const commands = [
  ...
  ['npx',['playwright','test','e2e/daily-practice.spec.js','e2e/practice-sync.spec.js','e2e/practice-accessibility.spec.js','e2e/production-detective.spec.js','--project=chromium','--project=firefox','--project=webkit','--workers=3',`--output=${join(output,'matrix')}`,'--reporter=line']],
