...
export const INTERVIEW_READY_QA_QUESTIONS = [
  {
    ...
    answer: {
      direct: "HashMap is not thread-safe, so concurrent reads and writes can lead to inconsistent behavior. ConcurrentHashMap is built for concurrent access and allows multiple threads to operate safely with much better throughput than synchronizing an entire map.",
