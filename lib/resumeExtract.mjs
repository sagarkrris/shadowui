...
async function loadPdfCanvasRuntime() {
  // pdfjs loads this optional dependency via require(). Import it directly so
  // serverless output tracing retains the native canvas module with pdf-parse.
