import { JAVA_INTERVIEW_QA, JAVA_PRODUCTION_GLOSSARY, JAVA_PRODUCTION_SCENARIOS, getJavaInterviewAnswerSteps, getJavaInterviewInternals } from "./javaDigest.mjs";
...
export const PUBLIC_ARTICLES = PUBLIC_ARTICLE_SEEDS.map((article) => ({
  ...
  glossary: article.source?.triage ? JAVA_PRODUCTION_GLOSSARY : [],
}));
