...
export const JAVA_EDITORIAL_CHAPTERS = {
  ...
  "Spring Boot configuration": {
    ...
    output: "The application starts only with a valid payment endpoint and timeout",
  ...
  "JDK vs JRE vs JVM": {
    ...
    mistakes: "Calling the JVM the compiler, treating the JRE as only the JVM, assuming Java source runs directly without a compiler, or relying on a separate JRE install for JDK 9+ deployments. Also remember that bytecode compatibility has direction: code compiled for a newer class-file version will not run on an older runtime.",
