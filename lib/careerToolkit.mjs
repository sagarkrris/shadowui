  ...
  return [
    {
      ...
      improved: `Improved: Evidence template — if your resume proves ${primaryGap}, state the real project, decision, and measured outcome. Otherwise, do not claim it; use a practice project to build evidence first.`,
      reason: "Missing skills cannot be rewritten as completed work.",
    },
    {
      id: "proof-bullet",
      title: "Add interview proof",
      original: `Missing visible proof for ${primaryGap}.`,
      improved: `Improved: Evidence template — add a verified ${primaryGap} example only when you can describe your actual ${secondaryGap} work, trade-offs, testing, and failure handling.`,
      reason: "This keeps the resume grounded in verifiable experience.",
    },
  ];
}
  ...
  return [
    {
      ...
      after: `Only add a ${primary} bullet if you have real evidence. Otherwise, use this as a practice-project prompt and collect a concrete result before claiming it on your resume.`,
      reason: "Missing skills must never become unsupported resume claims.",
    },
    {
      id: "jd-scope-metric",
      title: "Attach scope and metric",
      before: `Worked on ${secondary}.`,
      after: `If you have real ${secondary} experience, add its actual scope and outcome. If not, identify a project where you can build and measure this skill first.`,
      reason: "Use only evidence the candidate can verify; do not invent production impact or metrics.",
    },
  ];
}
