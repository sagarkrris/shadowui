...
export const TOPIC_CHIPS = {
  ...
  "SQL & Relational Databases": ["SQL query tuning", "Join practice", "Transaction scenarios", "Indexing interview questions", "Window functions explained"],
  "SAP Core": ["ABAP interview questions", "S/4HANA scenarios", "OData service practice", "Fiori basics", "SAP integration questions"],
  "Ruby Core": ["Ruby interview questions", "Rails MVC practice", "ActiveRecord scenarios", "RSpec testing drills", "Ruby performance review"],
  "Rust Core": ["Rust ownership practice", "Borrow checker questions", "Async Rust scenarios", "Trait interview questions", "Rust performance drills"],
};
