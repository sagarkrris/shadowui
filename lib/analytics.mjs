const ALLOWED_EVENTS = new Set(["detective_viewed", "detective_started", "detective_completed", "detective_returned", "detective_shared", "detective_share_visit", "unfinished_session_available", "ai_completed", "result_save_failed", "content_resolved", "result_recorded", "retest_completed", "ai_failed", "session_resumed", "draft_recovered", "answer_submitted", "content_reported", "page_view", "auth_started", "practice_started", "mock_completed", "readiness_shared", "guide_opened", "demo_answered", "demo_completed", "demo_skipped", "product_tour_scene", "product_tour_playback"]);
