export const WORKSPACE_TABS = [
  { id: "buildEngineering", label: "Build Engineering", shortLabel: "Build", icon: "ti-package", mobile: true },
  { id: "paths", label: "Career Paths", shortLabel: "Paths", icon: "ti-signpost", mobile: true },
  {
    id: "offerWarRoom",
  ...
  {
    id: "course",
    label: "AI for Software Engineers",
    shortLabel: "Course",
    icon: "ti-sparkles",
    mobile: true,
  },
