export const WORKSPACE_TABS = [
  {
    id: "collabMock",
    label: "Collaborative Mock",
    shortLabel: "Collab Mock",
    icon: "ti-users",
    mobile: true,
  },
  {
...
export function getWorkspaceTitle({
  ...
  if (normalizedTab === "collabMock") {
    return candidateProfile ? `Collaborative Mock for ${displayName || candidateProfile.name || "you"}` : "Collaborative Mock";
  }
