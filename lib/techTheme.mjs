...
const WORKSPACE_THEME_VARIANTS = {
  buildEngineering: { accent: "#78624a", accentStrong: "#c9aa7a", accentText: "#f0e4d1", surface: "#201f32", glyphs: ["Maven", "Gradle", "Builds"] },
  paths: { accent: "#466b88", accentStrong: "#8baec8", accentText: "#dcebf1", surface: "#14243a", glyphs: ["Paths", "Fresher", "Senior"] },
  chat: {
    accent: "#5b6f8f",
    accentStrong: "#9fb2d1",
    accentText: "#e0e7f2",
