...
export function getServerSideProps({ res }) {
  ...
  res.write(`<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>InterviewIQ Engineering Guides &amp; Cases</title><link>${SITE_URL}</link><description>Original Java, Spring, JVM, Kafka, SQL, and production interview guides.</description>${detectiveItems}${items}</channel></rss>`);
  res.end();
  return { props: {} };
}
