...
export default function CareerPaths({ theme = {}, profile = {}, onAction, onOpenWorkspace }) {
  ...
  return <div className="workspace-content"><section className="glass-card" style={{ background: "var(--jd-background)", border: "1px solid var(--jd-border-strong)", borderRadius: 9, color: "var(--jd-text)", display: "grid", gap: 14, padding: 15, width: "100%" }}>
